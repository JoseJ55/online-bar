...
function App() {
  return (
    <div id='app'>
        <div id='app-info'>
            <p>Seamless Ordering with the <span id='app-name'>Thirsty</span> App</p>
            <p id='app-sub-text'>Explore a diverse range of culinary delights and tantalizing drinks from the comfort of your phone.</p>
